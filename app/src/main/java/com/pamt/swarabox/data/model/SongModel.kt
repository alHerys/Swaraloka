...
data class SongModel(
    @SerialName("song_id") val id: String? = null,
    @SerialName("artist_id") val artistId: String? = null,
    val title: String,
    @SerialName("thumbnail_url") val thumbnailUrl: String,
    @SerialName("song_url") val songUrl: String,
    @SerialName("artist_name") val artistName: String? = null,
    @SerialName("song_duration") val songDuration: Int,
    @SerialName("is_active") val isActive: Boolean = true,
    @SerialName("created_at") val createdAt: Instant? = null, // TIMESTAMPTZ in SUPABASE
) {
    companion object {
